...
// Purpose: Level 10 — the final and hardest stage (Expert / 100 Arrows).
//          A configuration shell that feeds Level10Manager's layout into
//          BentLevelStateMixin. All gameplay logic lives in level_base.dart.
...
class _State extends State<GameScreenLvl10>
    with BentLevelStateMixin<GameScreenLvl10> {
  @override
  int get levelNumber => 10;
  @override
  int get rows => Level10Manager.rows;
  @override
  int get cols => Level10Manager.cols;
  @override
  int get arrowCount => 100;
  @override
  List<BentArrowData> Function() get buildArrowsFn => Level10Manager.build;
  @override
  Widget Function() get nextLevelBuilder => () => const GameScreenLvl10();
