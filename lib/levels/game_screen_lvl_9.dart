...
// Purpose: Level 9 entry-point screen. A thin configuration shell that
...
class _State extends State<GameScreenLvl9>
    with BentLevelStateMixin<GameScreenLvl9> {
  @override
  int get levelNumber => 9;
  @override
  int get rows => Level9Manager.rows;
  @override
  int get cols => Level9Manager.cols;
  @override
  int get arrowCount => 90;
  @override
  List<BentArrowData> Function() get buildArrowsFn => Level9Manager.build;
  @override
