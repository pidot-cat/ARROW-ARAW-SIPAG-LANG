...
// Purpose: Level 4 entry-point screen. A thin configuration shell that
...
class _State extends State<GameScreenLvl4>
    with BentLevelStateMixin<GameScreenLvl4> {
  @override
  int get levelNumber => 4;
  @override
  int get rows => Level4Manager.rows;
  @override
  int get cols => Level4Manager.cols;
  @override
  int get arrowCount => 40;
  @override
  List<BentArrowData> Function() get buildArrowsFn => Level4Manager.build;
  @override
  Widget Function() get nextLevelBuilder => () => const GameScreenLvl5();
