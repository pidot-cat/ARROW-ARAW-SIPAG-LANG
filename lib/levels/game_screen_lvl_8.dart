...
// Purpose: Level 8 entry-point screen. A thin configuration shell that
...
class _State extends State<GameScreenLvl8>
    with BentLevelStateMixin<GameScreenLvl8> {
  @override
  int get levelNumber => 8;
  @override
  int get rows => Level8Manager.rows;
  @override
  int get cols => Level8Manager.cols;
  @override
  int get arrowCount => 80;
  @override
  List<BentArrowData> Function() get buildArrowsFn => Level8Manager.build;
  @override
  Widget Function() get nextLevelBuilder => () => const GameScreenLvl9();
