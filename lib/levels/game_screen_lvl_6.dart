...
// Purpose: Level 6 entry-point screen. A thin configuration shell that
...
class _State extends State<GameScreenLvl6>
    with BentLevelStateMixin<GameScreenLvl6> {
  @override
  int get levelNumber => 6;
  @override
  int get rows => Level6Manager.rows;
  @override
  int get cols => Level6Manager.cols;
  @override
  int get arrowCount => 60;
  @override
  List<BentArrowData> Function() get buildArrowsFn => Level6Manager.build;
  @override
  Widget Function() get nextLevelBuilder => () => const GameScreenLvl7();
