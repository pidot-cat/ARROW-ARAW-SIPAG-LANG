    ...
    _countdownTimer = Timer.periodic(const Duration(seconds: 1), (t) {
      ...
      setState(() {
        if (_timerSeconds > 0) {
          ...
          _codeSent =
              false; // Hide OTP row so user can re-submit if code expired
        }
      });
    });
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_codeSent) ...[
                    // Only render if OTP has been sent
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(
                            width: 8), // Gap between field and button
                  ...
                  _isLoading
                      ...
                      : GradientButton(
                          ...
                          onPressed:
                              _codeSent ? _handleVerifyOtp : _handleSignUp,
                        ),
